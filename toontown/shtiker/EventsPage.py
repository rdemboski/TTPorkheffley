...
class EventsPage(ShtikerPage.ShtikerPage):
    ...
    def getActivityItem(self, activityBase, count = 1):
        ...
        iconString = PartyGlobals.ActivityIds(activityBase.activityId).name if not isinstance(activityBase.activityId, PartyGlobals.ActivityIds) else activityBase.activityId.name
    ...
    def getDecorationItem(self, decorBase, count = 1):
        ...
        assetName = PartyGlobals.DecorationIds(decorBase.decorId).name if not isinstance(decorBase.decorId, PartyGlobals.DecorationIds) else decorBase.decorId.name
        if assetName == 'Hydra':
