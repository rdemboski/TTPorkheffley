...
try:
    TTLocalizer.populatePartyLocalizerEnumKeys()
except Exception:
    pass
...
PhaseToMusicData = {3.5: {'TC_SZ.ogg': [TTLocalizer.MusicTcSz, 57]},
 3: {'create_a_toon.ogg': [TTLocalizer.MusicCreateAToon, 175],
     'ttr_d_theme_phase2_loop.ogg': [TTLocalizer.MusicTtTheme, 51]},
...
PhaseToMusicData40 = {3.5: {'encntr_general_bg.ogg': [TTLocalizer.MusicEncntrGeneralBg, 30],
 ...
 3: {'create_a_toon.ogg': [TTLocalizer.MusicCreateAToon, 175],
     'ttr_d_theme_phase2_loop.ogg': [TTLocalizer.MusicTtrTheme, 51]},
...
# Toonfest Globals (Soon to be seperate)

TrampolineNumTokens = 12
TrampolineTokenBonus = 10