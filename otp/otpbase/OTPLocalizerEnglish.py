...
CRBootedReasons = {1: 'Yikes - An unexpected problem occured.  Your connection has been lost, but you should be able to connect again and go right back into Toontown.',
 ...
 124: 'Your installed files are out of date!  Use the official launcher to download the newest version, or contact Toontown Porkheffley Support if the problem persists.',
 125: 'Your installed files appear to be invalid.  Use the official launcher to download the newest version, or contact Toontown Porkheffley Support if the problem persists.',
 126: 'You aren\'t authorized to use administrator privileges. The request has been noted.',
 127: 'There appears to be a problem with your Toon.  Don\'t worry - we\'ll get it straightened out. Please contact Toontown Porkheffley Support and referece Error Code 127.',
 ...
 152: "You have been banned from the game for a reported violation of our Terms of Use connected to '%(name)s'. For more details, please check the Toontown Porkheffley website.",
 ...
 154: 'Toontown Porkheffley is going down for an update!  Stay Tooned on our website for details, or try logging in again later.',
...
CRSystemMessages = {
    ...
    50: 'Toontown Porkheffley will be closing for an update soon. Start wrapping things up!',
    51: 'Toontown Porkheffley will be closing for an update in %s minutes.',
    52: 'Toontown Porkheffley will be closing for an update in %s seconds.',
    53: 'Toontown Porkheffley will be closing for an update in just a moment. Hang tight!',

    55: 'Toontown Porkheffley will be closing for maintenance soon. Start wrapping things up!',
    56: 'Toontown Porkheffley will be closing for maintenance in %s minutes.',
    57: 'Toontown Porkheffley will be closing for maintenance in %s seconds.',
    58: 'Toontown Porkheffley will be closing for maintanance in just a moment.',
...
CREnteringToontown = 'Toontown Porkheffley'
...
FriendSecretIntro = "If you are playing Toontown Porkheffley with someone you know in the real world, you can become True Friends.  You can chat using the keyboard with your True Friends.  Other Toons won't understand what you're saying.\n\nYou do this by getting a True Friend Code.  Tell the True Friend Code to your friend, but not to anyone else.  When your friend types in your True Friend Code on his or her screen, you'll be True Friends in Toontown!"
...
FriendSecretDetermineSecretAccountRollover = 'A friend across the Toontown Porkheffley network'
...
SpeedChatStaticTextToontown = {100: 'Hi!',
 ...
 5400: "Welcome to Toontown Porkheffley!",
